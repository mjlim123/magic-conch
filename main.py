                            ...
                            if (ctx.author.voice) and msg.content.lower().startswith(word) == True:
                                if msg.content.lower().startswith(word):
                                    if msg.content == "is daniel gay":
                                        ...
                                        vc.play(discord.FFmpegPCMAudio(executable="C:/Users/mj_li/Desktop/discord bot/MP3_Files/ffmpeg-n4.4-175-ga2bb836e55-win64-gpl-4.4/bin/ffmpeg.exe", source="C:/Users/mj_li/Desktop/discord bot/MP3_Files/" + yes[choice]))
                                        break
                                    elif msg.content.lower().startswith("guh"):
                                        vc.play(discord.FFmpegPCMAudio(executable="C:/Users/mj_li/Desktop/discord bot/MP3_Files/ffmpeg-n4.4-175-ga2bb836e55-win64-gpl-4.4/bin/ffmpeg.exe", source="C:/Users/mj_li/Desktop/discord bot/MP3_Files/"+ responses[9]))
                                        break
                                    elif msg.content.lower().startswith("sigh"):
                                        vc.play(discord.FFmpegPCMAudio(executable="C:/Users/mj_li/Desktop/discord bot/MP3_Files/ffmpeg-n4.4-175-ga2bb836e55-win64-gpl-4.4/bin/ffmpeg.exe", source="C:/Users/mj_li/Desktop/discord bot/MP3_Files/"+ responses[10]))
                                        break
                                    else:
                                        choice = random.randint(1,sizeOfDict)
                                        vc.play(discord.FFmpegPCMAudio(executable="C:/Users/mj_li/Desktop/discord bot/MP3_Files/ffmpeg-n4.4-175-ga2bb836e55-win64-gpl-4.4/bin/ffmpeg.exe", source="C:/Users/mj_li/Desktop/discord bot/MP3_Files/"+ responses[choice]))
                                        break
                                # elif msg.content.lower().startswith("does"):
                                #     choice = random.randint(1,sizeOfDict)
                                #     vc.play(discord.FFmpegPCMAudio(executable="C:/Users/mj_li/Desktop/discord bot/ffmpeg-n4.4-175-ga2bb836e55-win64-gpl-4.4/bin/ffmpeg.exe", source="C:/Users/mj_li/Desktop/discord bot/MP3_Files/"+ responses[choice]))
                                #     break
                                # elif msg.content.lower().startswith("guh"):
                                #     vc.play(discord.FFmpegPCMAudio(executable="C:/Users/mj_li/Desktop/discord bot/ffmpeg-n4.4-175-ga2bb836e55-win64-gpl-4.4/bin/ffmpeg.exe", source="C:/Users/mj_li/Desktop/discord bot/MP3_Files/"+ responses[choice]))
                                #     break
                                # elif msg.content.lower().startswith("sigh"):
                                #     vc.play(discord.FFmpegPCMAudio(executable="C:/Users/mj_li/Desktop/discord bot/ffmpeg-n4.4-175-ga2bb836e55-win64-gpl-4.4/bin/ffmpeg.exe", source="C:/Users/mj_li/Desktop/discord bot/MP3_Files/"+ responses[10]))
                                #     break
                                # elif msg.content == "is daniel gay":
                                #     choice = random.randint(1,2)
                                #     vc.play(discord.FFmpegPCMAudio(executable="C:/Users/mj_li/Desktop/discord bot/ffmpeg-n4.4-175-ga2bb836e55-win64-gpl-4.4/bin/ffmpeg.exe", source="C:/Users/mj_li/Desktop/discord bot/MP3_Files/" + yes[choice]))
                                #     break

                                else:
                                    print("Im in")
                                    choice = random.randint(1,sizeOfDict)
                                    vc.play(discord.FFmpegPCMAudio(executable="C:/Users/mj_li/Desktop/discord bot/ffmpeg-n4.4-175-ga2bb836e55-win64-gpl-4.4/bin/ffmpeg.exe", source=responses[choice]))
...
client.run('ODU2NjA0NDMxOTQ4ODQwOTgw.YNDdCw.7DgS7VuposPxmQhbbwTOogj137E')
